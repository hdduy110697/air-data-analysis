layui.use(['table'],function(){
    ...
    table.render({
        ...
        cols : [[
            ...
            {field: 'method', title: 'Action方式', align:'center',templet:function(d){
            ...
            {field: 'ip', title: 'ActionIP',  align:'center',minWidth:130},
            ...
            {field: 'operator',title: 'Action人', minWidth:100, templet:'#newsListBar',align:"center"},
            {field: 'operatingTime', title: 'Action时间', align:'center', width:170}
        ]]
    });
